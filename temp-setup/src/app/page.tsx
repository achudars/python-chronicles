      ...
      <div className="flex flex-col h-screen">
        ...
        <header className="bg-[#333] text-white p-4">
          <div className="flex items-center">
            ...
            <div className="ml-auto">
              <button className="bg-black text-white px-3 py-1 text-sm rounded-md">
                Share
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-1/2 p-6 overflow-y-auto border-r border-gray-200">
            ...
            <p className="mb-4">
              This is the basic view where you can write and execute Python code. It uses default materials, colors, and typography.
            </p>
            ...
            <p className="mb-4">
              The code snippet is loaded from a separate Python file and displayed in the editor on the right. You can modify the code and execute it to see the results.
            </p>
          </div>

          {/* Right side - Code editor */}
          <div className="w-1/2 bg-[#1e1e1e] text-white overflow-hidden flex flex-col">
            <CodeEditor />
          </div>
        </div>
      </div>
